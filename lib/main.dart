...
import 'package:ten_twenty_asgn/presentation/BottomNavigator.dart';
import 'package:ten_twenty_asgn/presentation/Theme/AppTheme.dart';
import 'package:ten_twenty_asgn/presentation/Theme/CommonColorsUtils.dart';
...
void configLoading() {
  EasyLoading.instance
    ...
    ..indicatorColor = CustomColors.DarkPrimaryColor
      ...
      child: BlocProvider(
        ...
        child: MaterialApp(
          ...
          theme: ThemeData(
              ...
              primarySwatch:CommonColorsUtils.createMaterialColor(AppTheme().getThemeFromKey().primaryColor)
          ),
